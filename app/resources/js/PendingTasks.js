...
myapp.controller('ngtableCtrl', function ($scope, NgTableParams, $filter, $uibModal) {
    ...
    $scope.overdue = [
        {
            date: '10/22/16 12:32 PM',
            overduelink: 'Resolve the case',
            overduecase: 'Cases'
        },
         {
             date: '10/21/16 12:32 PM',
             overduelink: 'Call Customer',
             overduecase: 'Cases'
         },
          {
              date: '10/14/16 10:46 AM',
              overduelink: 'Decision makers identified and spoken with',
              overduecase: 'Opportunities'
          },
           {
               date: '10/13/16 03:54 PM',
               overduelink: 'Resolve the case',
               overduecase: 'Opportunities'
           },
    ];
    ...
    $scope.upcoming = [
        {
            date: '10/22/16 12:32 PM',
            upcominglink: 'Willing and able',
            upcomingcase: 'Opportunities'
        },
        {
            date: '10/22/16 12:32 PM',
            upcominglink: 'Decision makers identified and spoken with',
            upcomingcase: 'Opportunities'
        }
    ];
    ...
    var data1 = ["row1", "row2", "row3", "row4", "row5", "row6", "row7", "row8", "row9", "row10", "row11", "row12"];
    var temp = {};
    var colname = '';
    var k = 0;
